                    ...
                    <div class="relative w-full h-full max-w-lg md:h-auto border-2 border-gray-500 rounded-lg shadow shadow-2xl items-center">
                        <div class="relative bg-white rounded-lg">
                            ...
                            <div class="p-6">
                                ...
                                <div className='container'>
                                    <img class="rounded-md w-200 h-100" src={"http://localhost:8080/uploads/image/" + this.state.foto} />
                                </div>
                                <div class="px-2 py-4">
                        ...
                        <div class="relative bg-white rounded-lg">
                            ...
                            <div class="p-6">
                                <div class="mb-4">
                                    ...
                                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="nama_tamu" name="nama_tamu" type="text" placeholder="Guest's Name" onChange={this.handleChange} value={this.state.nama_tamu} />
                                </div>
                                <div class="mb-4">
                                    <label class="block text-gray-700 text-sm font-bold mb-2" for="total_kamar">
                                        Total Rooms
                                    </label>
                                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="total_kamar" name="total_kamar" type="number" placeholder="Total Rooms" onChange={this.handleChange} value={this.state.total_kamar} />
                                </div>
                                <div class="flex items-center justify-between">
                                    <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button" onClick={() => this.handleAddBooking()}>
                                        Booking
                                    </button>
                                </div>
                            </div>
