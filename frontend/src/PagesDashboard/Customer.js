                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-white w-1/3">
                            ...
                            <div class="px-6 py-6 lg:px-8">
                                ...
                                <form class="space-y-6" onSubmit={(event) => this.handleSave(event)}>
                                    ...
                                    <div>
                                        <label for="nama_customer" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-800">Nama Customer</label>
                                        <input type="text" name="nama_customer" id="nama_customer" value={this.state.nama_customer} onChange={this.handleChange} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-gray-800 block w-full p-2.5 dark:bg-white dark:border-gray-500 dark:placeholder-gray-400 dark:text-gray-800" placeholder="Masukkan nama customer" required />
                                    </div>
                                    <div>
                                        <label for="alamat" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-800">alamat Customer</label>
                                        <input type="text" name="alamat" id="alamat" value={this.state.alamat} onChange={this.handleChange} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-gray-800 block w-full p-2.5 dark:bg-white dark:border-gray-500 dark:placeholder-gray-400 dark:text-gray-800" placeholder="Masukkan alamat customer" required />
                                    </div>
                                    <div>
